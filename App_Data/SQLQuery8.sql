...
insert into 团购项目(id,pickname,用户名,way,typee) values('1','草莓苗种植','呼呼歌','体验')
insert into 团购项目(id,pickname,用户名,way,typee) values('2','草莓苗种植','古丽那种','体验')
insert into 团购项目(id,pickname,用户名,way,typee) values('3','草莓苗种植','胡国公','体验')
insert into 团购项目(id,pickname,用户名,way,typee) values('4','购买土地','莎碧囵问吖吖嗄','购地')
...
insert into deldingdan(id,pickname,用户名,datetim,typee,reason) values('1','草莓苗种植','呼呼歌','4.22','体验','突然有事')
