...
insert into buypfcar(id,pfname,用户名,photo,price,ge,summ,pay) values(2,'蓝莓采摘','liufei','pick01.jpeg',60,1,60,'未付')

insert into buypfcar(id,pfname,用户名,photo,price,ge,summ,pay) values(1,'蓝莓采摘','liufei','pick01.jpeg',60,1,60,'未付')
insert into buypfcar(id,pfname,用户名,photo,price,ge,summ,pay) values(3,'蓝莓采摘','liufei','pick01.jpeg',60,1,60,'未付')
select * from buypfcar
