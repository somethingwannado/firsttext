<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="bbghknowledgeable2.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content3" runat="server" 
    contentplaceholderid="ContentPlaceHolder3">
                        ...
                        <p>
                            <asp:Button ID="Button1" runat="server" PostBackUrl="~/bbghknowledgeable.aspx" 
                                Text="返回水果列表" />
                                
                         </p>
                        <p>
                            &nbsp;</p>
                               <p style="font-family: 微软雅黑; font-size: x-large; font-weight: bold"> 水果知识详情</p>
